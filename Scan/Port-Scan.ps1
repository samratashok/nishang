...
.EXAMPLE
.\Port-Scan.ps1 -StartAddress 192.168.0.1 -EndAddress 192.168.0.254

.EXAMPLE
.\Port-Scan.ps1 -StartAddress 192.168.0.1 -EndAddress 192.168.0.254 -ResolveHost

.EXAMPLE
.\Port-Scan.ps1 -StartAddress 192.168.0.1 -EndAddress 192.168.0.254 -ResolveHost -ScanPort

.EXAMPLE
.\Port-Scan.ps1 -StartAddress 192.168.0.1 -EndAddress 192.168.0.254 -ResolveHost -ScanPort -TimeOut 500

.EXAMPLE
.\Port-Scan.ps1 -StartAddress 192.168.0.1 -EndAddress 192.168.10.254 -ResolveHost -ScanPort -Port 80
